...
import ShareConfirmationScreen from "./screens/ShareConfirmationScreen";
...
function LogoTitle() {
  return <Image style={styles.logo} source={require("./screens/logo.png")} />;
}
        ...
        <Stack.Navigator
          screenOptions={{
            ...
            headerBackImage: () => (
              <Image
                style={styles.back}
                source={require("./screens/previous.png")}
              />
            ),
