  ...
  return (
    <View style={styles.container}>
      <View style={styles.outer}>
        <Text style={styles.question}>Pick Artist(s)</Text>
      </View>
      <View style={styles.inner}>
        <View style={styles.row}>
          ...
          >
            <Text style={styles.boxText}>Ariana Grande</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={()=> {
          ...
          >
            <Text style={styles.boxText}>Travis Scott</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.row}>
          <TouchableOpacity
          ...
          >
            <Text style={styles.boxText}>SZA</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={()=> {
          ...
          >
            <Text style={styles.boxText}>Clairo</Text>
          </TouchableOpacity>
        </View>
      </View>
