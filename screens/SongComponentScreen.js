...
export default function PickArtistScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.outer}>
        <Text style={styles.question}>What's your favorite part of a song?</Text>
      </View>
      <View style={styles.inner}>
        <View style={styles.row}>
          ...
          >
            <Text style={styles.boxText}>Lyrics</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={()=> {
          ...
          >
            <Text style={styles.boxText}>Beat</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.row}>
          <TouchableOpacity
      ...
      <View style={styles.progress}>
        <ProgressBar progress={0.75} color={'#f4b400'} />
      </View>
      <View style={styles.outer}>
        <TouchableOpacity 
          style={styles.button}
          onPress={() => {navigation.navigate('ReasonScreen')}}
        >
